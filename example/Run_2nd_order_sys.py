...
for i in range(len(y[0])):
    p1 = ax.scatter(y[0][i], zeta[0], color=color[0], marker='s', s=500)
    p2 = ax.scatter(y[1][i], zeta[1], color=color[1], marker='s', s=500)
    p3 = ax.scatter(y[2][i], zeta[2], color=color[2], marker='s', s=500)
    p4 = ax.scatter(y[3][i], zeta[3], color=color[3], marker='s', s=500)
    p5 = ax.scatter(y[4][i], zeta[4], color=color[4], marker='s', s=500)
    p6 = ax.scatter(y[5][i], zeta[5], color=color[5], marker='s', s=500)
    ax.label_outer()
...
ax.grid(visible=True, which='both', axis='both')
plt.subplots_adjust(top=0.9, bottom=0.2, right=0.9, left=0.2)
ax.plot([1, 1], [0, 3.2], color='k')

ims = []
for i in range(len(y[0])):
    p1 = ax.scatter(y[0][i], fn[0], color=color[0], marker='s', s=500)
    p2 = ax.scatter(y[1][i], fn[1], color=color[1], marker='s', s=500)
    p3 = ax.scatter(y[2][i], fn[2], color=color[2], marker='s', s=500)
    p4 = ax.scatter(y[3][i], fn[3], color=color[3], marker='s', s=500)
    p5 = ax.scatter(y[4][i], fn[4], color=color[4], marker='s', s=500)
    p6 = ax.scatter(y[5][i], fn[5], color=color[5], marker='s', s=500)
    ax.label_outer()
    ims.append([p1, p2, p3, p4, p5, p6])
