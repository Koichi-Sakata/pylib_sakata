...
plot.plot_xy(ax1, time, NoiseOut, '-', 'b', 1.5, 1.0, ylabel='[N]', legend=['Sig'], loc='upper right', title='Time response')
plot.plot_xy(ax2, time, ServoOutN, '-', 'b', 1.5, 1.0, ylabel='[N]', legend=['In'], loc='upper right')
plot.plot_xy(ax3, time, ActPosUm, '-', 'b', 1.5, 1.0, ylabel='[um]', legend=['Out'], loc='upper right')
plot.plot_xy(ax4, time, FlagInject, '-', 'b', 1.5, 1.0, xlabel='Time [s]', ylabel='[.]', legend=['Flag'], loc='upper right')
