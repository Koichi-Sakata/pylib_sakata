...
plot.plot_tffrd(ax_mag, ax_phase, Sn_fssrc_frd, '-', 'm', 1.5, 1.0, freqrange, [-60, 20], legend='FS-SRC')
...
plot.plot_tffrd(ax_mag, ax_phase, Tn_fssrc_frd, '-', 'm', 1.5, 1.0, freqrange, [-60, 20], phasebase=180, legend='FS-SRC')
...
plot.plot_nyquist(ax, Gn_fssrc_frd, '-', 'm', 1.5, 1.0, legend='FS-SRC')
...
plot.plot_nyquist(ax, Gn1_frd, '-', 'b', 1.5, 1.0, legend='Motor side', title='Nyquist Diagram')
plot.plot_nyquist(ax, Gn2_frd, '-', 'r', 1.5, 1.0, legend='Load side')
plot.plot_nyquist(ax, Gn_fssrc_frd, '-', 'm', 1.5, 1.0, xrange=[-5, 5], yrange=[-5, 5], legend='FS-SRC')
plot.plot_nyquist_assistline(ax)
