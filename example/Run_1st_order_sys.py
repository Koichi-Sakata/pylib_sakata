...
# Common parameters
figurefolderName = 'figure_1st_order_sys'
...
ani.save(figurefolderName+'/animation.gif', writer='pillow')
...
plot.savefig(figurefolderName+'/freq_pole.png')
