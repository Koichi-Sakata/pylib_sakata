...
plot.plot_xy(ax1, traj3.time, traj3.pos, '-', 'r', 1.5, 1.0)
plot.plot_xy(ax1, traj4.time, traj3.pos, '-', 'm', 1.5, 1.0)
plot.plot_xy(ax1, traj5.time, traj5.pos, '-', 'g', 1.5, 1.0, ylabel='Pos [m]', title='Time response', legend=['4th', '4th v2', 'sin', 'sin v2', 'sin v3'])
plot.plot_xy(ax2, traj1.time, traj1.vel, '--', 'b', 1.5, 1.0)
plot.plot_xy(ax2, traj2.time, traj2.vel, '--', 'c', 1.5, 1.0)
plot.plot_xy(ax2, traj3.time, traj3.vel, '-', 'r', 1.5, 1.0)
plot.plot_xy(ax2, traj4.time, traj4.vel, '-', 'm', 1.5, 1.0)
plot.plot_xy(ax2, traj5.time, traj5.vel, '-', 'g', 1.5, 1.0, ylabel='Vel [m/s]')
plot.plot_xy(ax3, traj1.time, traj1.acc, '--', 'b', 1.5, 1.0)
plot.plot_xy(ax3, traj2.time, traj2.acc, '--', 'c', 1.5, 1.0)
plot.plot_xy(ax3, traj3.time, traj3.acc, '-', 'r', 1.5, 1.0)
plot.plot_xy(ax3, traj4.time, traj4.acc, '-', 'm', 1.5, 1.0)
plot.plot_xy(ax3, traj5.time, traj5.acc, '-', 'g', 1.5, 1.0, ylabel='Acc [m/s2]')
plot.plot_xy(ax4, traj1.time, traj1.jerk, '--', 'b', 1.5, 1.0)
plot.plot_xy(ax4, traj2.time, traj2.jerk, '--', 'c', 1.5, 1.0)
plot.plot_xy(ax4, traj3.time, traj3.jerk, '-', 'r', 1.5, 1.0)
plot.plot_xy(ax4, traj4.time, traj4.jerk, '-', 'm', 1.5, 1.0)
plot.plot_xy(ax4, traj5.time, traj5.jerk, '-', 'g', 1.5, 1.0, xlabel='Time [s]', ylabel='Jerk [m/s3]')
plot.plot_xy(ax5, traj1.time, traj1.snap, '--', 'b', 1.5, 1.0)
plot.plot_xy(ax5, traj2.time, traj2.snap, '--', 'c', 1.5, 1.0)
plot.plot_xy(ax5, traj3.time, traj3.snap, '-', 'r', 1.5, 1.0)
plot.plot_xy(ax5, traj4.time, traj4.snap, '-', 'm', 1.5, 1.0)
plot.plot_xy(ax5, traj5.time, traj5.snap, '-', 'g', 1.5, 1.0, xlabel='Time [s]', ylabel='Snap [m/s4]')
...
plot.plot_xy(ax1, freq_fft4, jerk5_fft, '-', 'g', 1.5, 1.0, xscale='log', yscale='log', xrange=[1.0, 100.0], yrange=[0.001, 100], xlabel='Frequency [Hz]', ylabel='Ref Jerk [mm/s3]', legend=['4th', '4th v2', 'sin', 'sin v2', 'sin v3'])
