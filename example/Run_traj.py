...
plot.plot_xy(ax3, traj5.time, traj5.acc, '-', 'g', 1.0, 1.0, ylabel='Acc [m/$\mathrm{s^2}$]')
...
plot.plot_xy(ax4, traj5.time, traj5.jerk, '-', 'g', 1.0, 1.0, xlabel='Time [s]', ylabel='Jerk [m/$\mathrm{s^3}$]')
...
plot.plot_xy(ax5, traj5.time, traj5.snap, '-', 'g', 1.0, 1.0, xlabel='Time [s]', ylabel='Snap [m/$\mathrm{s^4}$]')
...
plot.plot_xy(ax1, freq_fft4, jerk5_fft, '-', 'g', 1.5, 1.0, xscale='log', yscale='log', xrange=[1.0, 100.0], yrange=[0.001, 100], xlabel='Frequency [Hz]', ylabel='Ref Jerk [mm/$\mathrm{s^3}$]', legend='sin v3')
