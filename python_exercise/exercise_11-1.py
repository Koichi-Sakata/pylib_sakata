...
# Common parameters
figurefolderName = 'figure_exercise_11-1'
...
plot.plot_tffrd(ax_mag, ax_phase, Pns0_frd, '-', 'k', 1.5, 1.0, legend='Rigid', title='Frequency response of plant')
plot.plot_tffrd(ax_mag, ax_phase, Pns1_frd, '-', 'b', 1.5, 1.0, legend='Motor side')
plot.plot_tffrd(ax_mag, ax_phase, Pns2_frd, '-', 'r', 1.5, 1.0, freqrange, legend='Load side')
...
ax_mag = fig.add_subplot(211)
ax_phase = fig.add_subplot(212)
plot.plot_tffrd(ax_mag, ax_phase, Gn0_frd, '-', 'k', 1.5, 1.0, legend='Rigid', title='Frequency response of open loop transfer function')
plot.plot_tffrd(ax_mag, ax_phase, Gn1_frd, '-', 'b', 1.5, 1.0, legend='Motor side')
...
ax_phase = None
plot.plot_tffrd(ax_mag, ax_phase, Sn0_frd, '-', 'k', 1.5, 1.0, legend='Rigid', title='Frequency response of sensitivity function')
plot.plot_tffrd(ax_mag, ax_phase, Sn1_frd, '-', 'b', 1.5, 1.0, legend='Motor side')
...
ax_mag = fig.add_subplot(211)
ax_phase = fig.add_subplot(212)
plot.plot_tffrd(ax_mag, ax_phase, Tn0_frd, '-', 'k', 1.5, 1.0, phasebase=180, legend='Rigid', title='Frequency response of complementary sensitivity function')
plot.plot_tffrd(ax_mag, ax_phase, Tn1_frd, '-', 'b', 1.5, 1.0, phasebase=180, legend='Motor side')
...
plot.plot_nyquist(ax, Gn0_frd, '-', 'k', 1.5, 1.0, xrange=[-20, 10], yrange=[-15, 15], legend='Rigid', title='Nyquist Diagram')
plot.plot_nyquist(ax, Gn1_frd, '-', 'b', 1.5, 1.0, xrange=[-20, 10], yrange=[-15, 15], legend='Motor side')
...
fig = plot.makefig()
ax = fig.add_subplot(111)
plot.plot_nyquist(ax, Gn0_frd, '-', 'k', 1.5, 1.0, legend='Rigid', title='Nyquist Diagram')
plot.plot_nyquist(ax, Gn1_frd, '-', 'b', 1.5, 1.0, legend='Motor side')
