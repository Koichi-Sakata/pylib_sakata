...
ax_mag = fig.add_subplot(211)
ax_phase = fig.add_subplot(212)
plot.plot_tffrd(ax_mag, ax_phase, Gn0_frd, '-', 'k', 1.5, 1.0, title='Frequency response of open loop transfer function')
plot.plot_tffrd(ax_mag, ax_phase, Gn1_frd, '-', 'b', 1.5, 1.0)
plot.plot_tffrd(ax_mag, ax_phase, Gn2_frd, '-', 'r', 1.5, 1.0, freqrange, legend=['Rigid', 'Motor side', 'Load side'])
...
ax_phase = None
plot.plot_tffrd(ax_mag, ax_phase, Sn0_frd, '-', 'k', 1.5, 1.0, title='Frequency response of sensitivity function')
plot.plot_tffrd(ax_mag, ax_phase, Sn1_frd, '-', 'b', 1.5, 1.0)
plot.plot_tffrd(ax_mag, ax_phase, Sn2_frd, '-', 'r', 1.5, 1.0, freqrange, [-60, 20], legend=['Rigid', 'Motor side', 'Load side'])
...
ax_mag = fig.add_subplot(211)
ax_phase = fig.add_subplot(212)
plot.plot_tffrd(ax_mag, ax_phase, Tn0_frd, '-', 'k', 1.5, 1.0, title='Frequency response of complementary sensitivity function')
plot.plot_tffrd(ax_mag, ax_phase, Tn1_frd, '-', 'b', 1.5, 1.0)
plot.plot_tffrd(ax_mag, ax_phase, Tn2_frd, '-', 'r', 1.5, 1.0, freqrange, [-60, 20], legend=['Rigid', 'Motor side', 'Load side'])
...
fig = plot.makefig()
ax = fig.add_subplot(111)
plot.plot_nyquist(ax, Gn0_frd, '-', 'k', 1.5, 1.0, title='Nyquist Diagram')
plot.plot_nyquist(ax, Gn1_frd, '-', 'b', 1.5, 1.0)
plot.plot_nyquist(ax, Gn2_frd, '-', 'r', 1.5, 1.0, legend=['Rigid', 'Motor side', 'Load side'])
plot.plot_nyquist_assistline(ax)
