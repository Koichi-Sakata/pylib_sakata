...
plot.plot_nyquist(ax, Gn1_frd, '-', 'b', 1.5, 1.0, xrange=[-20, 10], yrange=[-15, 15], title='Nyquist Diagram')
plot.plot_nyquist(ax, Gn2_frd, '-', 'r', 1.5, 1.0, xrange=[-20, 10], yrange=[-15, 15])
plot.plot_nyquist(ax, Gn1_nf_frd, '-', 'c', 1.5, 1.0, xrange=[-20, 10], yrange=[-15, 15])
plot.plot_nyquist(ax, Gn2_nf_frd, '-', 'm', 1.5, 1.0, xrange=[-20, 10], yrange=[-15, 15], legend=['Motor side', 'Load side', 'Motor side with NF', 'Load side with NF'])
