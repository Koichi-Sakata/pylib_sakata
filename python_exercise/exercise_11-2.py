...
ax_mag = fig.add_subplot(211)
ax_phase = fig.add_subplot(212)
plot.plot_tffrd(ax_mag, ax_phase, NFs_frd, '-', 'b', 1.5, 1.0, freqrange, phasebase=180, title='Frequency response of notch filters')
...
ax_mag = fig.add_subplot(211)
ax_phase = fig.add_subplot(212)
plot.plot_tffrd(ax_mag, ax_phase, Cs_frd, '-', 'b', 1.5, 1.0, freqrange, phasebase=180, legend='w/o NF', title='Frequency response of PID controller')
plot.plot_tffrd(ax_mag, ax_phase, Cs_frd * NFs_frd, '-', 'r', 1.5, 1.0, freqrange, phasebase=180, legend='with NF')
...
plot.plot_nyquist(ax, Gn1_nf_frd, '-', 'c', 1.5, 1.0, xrange=[-20, 10], yrange=[-15, 15], legend='Motor side with NF')
plot.plot_nyquist(ax, Gn2_nf_frd, '-', 'm', 1.5, 1.0, xrange=[-20, 10], yrange=[-15, 15], legend='Load side with NF')
