...
# Time response
measdata = meas.getdata('data/time_resp_2mass_20250124.csv')
time = measdata.time
...
measdata_nf = meas.getdata('data/time_resp_2mass_nf_20250124.csv')
...
measdata_nf_rf = meas.getdata('data/time_resp_2mass_nf_rf_20250124.csv')
...
plot.plot_xy(ax2, time_nf_rf, ErrPosUm_nf_rf, '-', 'r', 1.5, 1.0, yrange=[-4.0, 4.0], ylabel='Error Pos [um]')
...
plot.plot_xy(ax2, freq_fft_nf_rf, ServoOutN_fft_nf_rf, '--', 'r', 1.5, 1.0, xscale='log', xrange=[1.0, 1000.0], yrange=[0.0, 0.002], xlabel='Frequency [Hz]', ylabel='ServoOut [N]', legend=['w/o Filters', 'with NF', 'with NF+RF'])
...
plot.plot_xy(ax2, time_sim_nf_rf, ErrPosUm_sim_nf_rf, '--', 'r', 1.5, 1.0, yrange=[-2.0, 2.0], xlabel='Time [s]', ylabel='Error Pos [um]', legend=['w/o Filters (Exp)', 'with NF (Sim)', 'with NF+RF (Sim)'], loc='upper right')
